...
/**
 * Crop options that are required to crop the video
 */
declare interface VideoEditorCropProperties {
  /** A well-known location where the editable video lives. */
  fileUri: string,
  /** The height value to begin cropping the video. */
  width: number,
  /** The width value to begin cropping the video. */
  height: number,
  /** The value of X to begin cropping the video. */
  startX: number,
  /** The value of Y to begin cropping the video. */
  startY: number,
  /** A string that indicates what type of field this is, home for example. */
  outputFileName: string,
  /** Progress on transcode. */
...
interface VideoEditor {
    ...
    */
    ...
    /**
     * The VideoEditor.crop method executes asynchronously, cropping the video.
     * The resulting info object is passed to the onSuccess callback function specified by the onSuccess parameter.
     * @param onSuccess Success callback function invoked with the details of the video.
     * @param onError Error callback function, invoked when an error occurs.
     * @param cropOptions Info options that are required to locate the video.
     */
    crop(onSuccess: (path: string) => void,
         onError: (error: any) => void,
         trimOptions: VideoEditorCropProperties): void;
}
